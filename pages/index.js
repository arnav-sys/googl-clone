...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <form className="w-4/5 flex flex-col items-center mt-44 flex-grow">
        <Image
          height={100}
          width={300}
        ...
        />
        <div className="flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md rounded-full sm:max-w-xl lg:max-w-2xl border border-gray-300 px-5 py-3 items-center">
          ...
          />
          <MicrophoneIcon type="text" className="h-5" />
        </div>
        <div className="flex ">
